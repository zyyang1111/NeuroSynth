function [mult_queue, mult_out_ind, mult_out_num, add_queue, add_out_ind, add_out_num, out_done, cycle_num, tot_energy, stall_cycle, mult_energy, add_energy] = one_cycle_pipeline_4(multipliers, mult_use, mult_queue, mult_out_ind, mult_out_num, add_queue, add_out_ind, add_out_num, out_ind_base, tm, num_add_input, out_done, out_done_num, cycle_num, mult_queue_size, add_queue_size, add_energy_0, tot_energy, w_map, add_cycle, add_energy, mult_energy)
