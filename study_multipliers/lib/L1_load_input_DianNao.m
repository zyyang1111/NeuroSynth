function [L1_store_in_size, L1_load_in_size, L1_in_tag] = L1_load_input_DianNao(rr, cc, ti, trr, tcc, tn, S, K, tk)

% L1_store_in_size = trr * tcc * tn * K * tk; 
% % convert L1_store_in_size to bytes 
% L1_store_in_size = L1_store_in_size * 2; 

row_e = rr+trr-1; 
row_in_e = (row_e-1)*S+tk; 
row_in_s = (rr-1)*S+1; 
col_e = cc+tcc-1;
...
L1_store_in_size = L1_load_in_size;
