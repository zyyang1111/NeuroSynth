function [mult_queue, mult_out_ind, mult_out_num] = allocate_mult_use_withmap2(multipliers, mult_queue, mult_out_ind, mult_out_num, mult_use_array, out_ind_base, Tm, w_map)
