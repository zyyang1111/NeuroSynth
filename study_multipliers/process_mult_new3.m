function [mult_queue, mult_out_ind, mult_out_num, add_queue, add_out_ind, add_out_num, tot_energy] = process_mult_new3(multipliers, mult_queue, mult_out_ind, mult_out_num, add_queue, add_out_ind, add_out_num, Tm, tot_energy, out_ind_base, mult_energy)
...
%     for j = 1 : mult_out_ind(i,1)
        if mult_out_num(i, j+1) <= num_processed
            ...
            add_queue(mod(out_ind, 100)) = add_queue(mod(out_ind, 100)) + mult_out_num(i, j+1);
            if add_out_ind(mod(out_ind, 100), add_out_ind(mod(out_ind, 100),1)+1) == out_ind
                add_out_num(mod(out_ind, 100), add_out_num(mod(out_ind, 100),1)+1) = ...
                    add_out_num(mod(out_ind, 100), add_out_num(mod(out_ind, 100),1)+1) + mult_out_num(i, j+1);
            else
            ...
            out_ind = mult_out_ind(i,j+1); 
            add_queue(mod(out_ind, 100)) = add_queue(mod(out_ind, 100)) + num_processed;
            if add_out_ind(mod(out_ind, 100), add_out_ind(mod(out_ind, 100),1)+1) == out_ind
                add_out_num(mod(out_ind, 100), add_out_num(mod(out_ind, 100),1)+1) = ...
                    add_out_num(mod(out_ind, 100), add_out_num(mod(out_ind, 100),1)+1) + num_processed;
            else
                add_out_ind(mod(out_ind, 100),1) = add_out_ind(mod(out_ind, 100),1) + 1;
                add_out_num(mod(out_ind, 100),1) = add_out_num(mod(out_ind, 100),1) + 1;
                add_out_ind(mod(out_ind, 100), add_out_ind(mod(out_ind, 100),1)+1) = out_ind; 
